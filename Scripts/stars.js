...
(function($) {
    ...
    function anim() {
    	...
    	timeout=setTimeout(function() { anim(); },fps);
    }
    ...
    $("body").html('<canvas id="starfield" style="position:fixed;width:100%;height:100%;top:0px;left:0px;background-color:#000000"></canvas><div id="non_starfield">' + $("body").html() + '</div>');
    $("body").bind('resize, orientationchange', function() { resize(); });
    $("body").bind('mouseup', function() { context.fillStyle='rgb(0,0,0)'; });
    $("body").bind('mousedown', function() { context.fillStyle='rgba(0,0,0,'+opacity+')'; });
    $("#non_starfield").css({
		'position': 		'relative',
		'display': 			'block',
		'margin': 			'auto',
